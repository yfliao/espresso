...
def collate(samples):
    try:
        ...
        raise ImportError("Please install OpenFST and PyChain by `make openfst pychain` in espresso/tools")
...
class AsrChainDataset(FairseqDataset):
    ...
    Args:
        ...
        dictionary (~fairseq.data.Dictionary, optional): text vocabulary
    ...
    def __init__(
        self, src, src_sizes, tgt=None, tgt_sizes=None, text=None, dictionary=None,
